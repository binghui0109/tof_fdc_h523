...
#define AI_NETWORK_MODEL_SIGNATURE     "0xcf3de3874454318ea472204b4b7b62e8"
...
#define AI_TOOLS_DATE_TIME   "2026-01-30T15:07:24+0800"
...
AI_TENSOR_OBJ_DECLARE(
  ...
  1, 0x0,
  AI_SHAPE_INIT(4, 72, 3, 1, 1), AI_STRIDE_INIT(4, 4, 288, 864, 864),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  4, 0x0,
  AI_SHAPE_INIT(4, 1, 1, 8, 8), AI_STRIDE_INIT(4, 4, 4, 4, 32),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 1196, 1, 1),
    1196, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 932, 1, 1),
    932, NULL, NULL),
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_activations_map, 1, params)) {
    ...
    input_1_output_array.data = AI_PTR(g_network_activations_map[0] + 256);
    input_1_output_array.data_start = AI_PTR(g_network_activations_map[0] + 256);
    conv2d_scratch0_array.data = AI_PTR(g_network_activations_map[0] + 512);
    conv2d_scratch0_array.data_start = AI_PTR(g_network_activations_map[0] + 512);
    conv2d_scratch1_array.data = AI_PTR(g_network_activations_map[0] + 548);
    conv2d_scratch1_array.data_start = AI_PTR(g_network_activations_map[0] + 548);
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    conv2d_bias_array.data = AI_PTR(g_network_weights_map[0] + 288);
    conv2d_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 288);
    dense_dense_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_dense_weights_array.data = AI_PTR(g_network_weights_map[0] + 320);
    dense_dense_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 320);
    dense_dense_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_dense_bias_array.data = AI_PTR(g_network_weights_map[0] + 1184);
    dense_dense_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 1184);
    return true;
  }
